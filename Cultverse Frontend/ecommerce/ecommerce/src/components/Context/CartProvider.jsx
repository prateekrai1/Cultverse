...
export  function CartHandShake ({ children }) {
    ...
    const addToCart = (item) => {
      ...
      const getCartTotal = () => {
        return cartItems.reduce((total, item) => total + item.item_price * item.quantity, 0); // calculate the total price of the items in the cart
      };
      return (
